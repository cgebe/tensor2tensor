...
def main():
    for problem in LABEL_PROBLEMS:
        ...
        while not successful:
            cmd = "python ./t2t-trainer --data_dir=$DATA_DIR/multi_labeling --output_dir=$TRAIN_DIR/multi_labeling/"+problem+" --worker_gpu=4 --train_steps=100000 --model=multi_model --hparams_set=multimodel_legal --local_eval_frequency=500 --save_checkpoints_secs=90 --problems="+problem
            if os.system(cmd) == 0:
                successful = True
