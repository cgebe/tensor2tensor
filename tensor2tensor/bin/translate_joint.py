...
def main():
    ...
    while not successful:
        print(joint)
        cmd = "python ./t2t-trainer --data_dir=$DATA_DIR/translate/joint --output_dir=$TRAIN_DIR/translate/joint-diverse --worker_gpu=4 --train_steps=250000 --model=multi_model --hparams_set=multimodel_legal --problems="+joint
        if os.system(cmd) == 0:
            successful = True
