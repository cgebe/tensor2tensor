...
def main():
    for problem in TRANSLATE_PROBLEMS:
        ...
        while not successful:
            cmd = "python ./t2t-trainer --data_dir=$DATA_DIR/translate --output_dir=$TRAIN_DIR/transformer/translate/"+problem+" --worker_gpu=4 --training_steps=500000 --model=multi_model --hparams_set=multimodel_base --problems="+problem
            if os.system(cmd) == 0:
                successful = True
