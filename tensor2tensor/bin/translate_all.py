...
def main():
    for problem in TRANSLATE_PROBLEMS:
        cmd = "python ./t2t-trainer --data_dir=$DATA_DIR/translate/"+problem+" --output_dir=$TRAIN_DIR/translate/"+problem+" --worker_gpu=4 --training_steps=500000 --model=multi_model --hparams_set=multimodel_legal --problems="+problem
        os.system(cmd)
